This  file  contai  the   following   instructions   to solve the   given  project  
...
allocated space in memory, which contains s1, followed by the first n bytes of s2, and null terminated
...
No.6 We must accept finite disappointment, but never lose infinite hope
